    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('users', 'users'), ('superuser', 'superuser'), ('staff', 'staff')], default='users', max_length=100)),
                ('forgot_password_token', models.CharField(blank=True, default='', max_length=200, null=True)),
